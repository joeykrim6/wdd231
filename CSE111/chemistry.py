...
def main():
    ...
    mass_in_grams = float(input("Enter the mass of the sample in grams: "))
    ...
    common_formula_name = get_formula_name(formula, known_molecules_dict)
    
    print(f"Molar mass: {molar_mass} g/mol")
    
    print(f"Number of moles: {moles:.5f} mol")
    
    print(F"Known Chemical Formula name: {common_formula_name}")
